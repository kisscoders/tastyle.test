...
const TeamBox1 = styled(Container)`
  ...
  return (
    <Container className="my-5">
      <CustomCorousel>
        ...
        <CustomCorousel.Item>
          <Crop>
            <Image fluid className="d-block w-100" src={img_person_2} />
          </Crop>
          <CustomCorousel.Caption>
        ...
        <CustomCorousel.Item>
          <Crop>
            <Image fluid className="d-block w-100" src={img_products_1} />
          </Crop>
          <CustomCorousel.Caption>
            <TAG2>Be Amazed</TAG2>
          </CustomCorousel.Caption>
      ...
      <div className="container mt-4">
        ...
        <Row1>
          ...
          <Col sm={8}>
            <Image className="mb-4" width="100%" src={img_person_3} />
            <Quote>
      ...
      <TeamBox1>
        ...
        <br></br>
        <Row>
          <Col sm={2} md={3} className="mx-auto">
            <Image1 src={img_team_t} />
            <br></br>
            <br></br>
            <div>
          ...
          <Col sm={2} md={3} className="About_Team_Image">
            <Image1 src={img_team_a} />
            <br></br>
            <br></br>
